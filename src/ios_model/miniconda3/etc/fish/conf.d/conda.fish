set -gx CONDA_EXE (cygpath "C:/MISC/Deepcare/Orthodontics/src/ios_model/miniconda3\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:/MISC/Deepcare/Orthodontics/src/ios_model/miniconda3")
set _CONDA_EXE (cygpath "C:/MISC/Deepcare/Orthodontics/src/ios_model/miniconda3\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:/MISC/Deepcare/Orthodontics/src/ios_model/miniconda3\python.exe")
