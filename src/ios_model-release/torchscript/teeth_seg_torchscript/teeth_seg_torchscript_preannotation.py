...
if __name__ == "__main__":
    ...
    max_script_path = "./max_teeth_seg_model_script.pt"
    man_script_path = "./man_teeth_seg_model_script.pt"
    max_model = torch.jit.load(max_script_path)
    man_model = torch.jit.load(man_script_path)
    max_model.to(device)
    max_model.eval()
    man_model.to(device)
    man_model.eval()
